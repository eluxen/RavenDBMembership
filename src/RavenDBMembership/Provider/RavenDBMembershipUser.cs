...
namespace RavenDBMembership.Provider
{
    ...
    {
        public RavenDBMembershipUser(string providerName, string username, object id, string email, string passwordQuestion, string comment, bool isApproved, bool isLockedOut, DateTime creationDate, DateTime lastLoginDate, DateTime lastActivityDate, DateTime lastPasswordChangedDate, DateTime lastLockoutDate)
